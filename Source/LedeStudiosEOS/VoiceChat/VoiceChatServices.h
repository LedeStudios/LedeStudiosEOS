...
UCLASS()
class LEDESTUDIOSEOS_API AVoiceChatServices : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintNativeEvent, BlueprintCallable, BlueprintPure, Category = "Voice")
    ELSEOS_VoiceChatTransmitMode GetTransmitMode();

    UFUNCTION(BlueprintNativeEvent, BlueprintCallable, Category = "Voice")
    void SetTransmitMode(const enum ELSEOS_VoiceChatTransmitMode &TransmitMode);
